...
void intro() {
	printf ("\n");
    printf ("Program: Comparison of Calculated Round-Off Errors.\n");
    printf ("Info: Khoi Le, kle109Hw4. \n");
    printf ("Function: A program that illustrates round-off errors using trig-identities.\n");
	printf ("\n");
}
...
int main() {
    ...
    long double base = 0;
	int u1;
    printf("Please enter a degree value for u: \n");
    scanf("%d%c", &u1,&returnchar);
	while (u1 < 0) {
	...
	int v1;
    printf("Please enter a degree value for v: \n");
    scanf("%d", &v1);
	while (v1 < 0 || v1 == u1) {
		if (v1 == u1){
		printf("Value is non positive\n");
...
//summary
	...
	long double cc3;
// stats average
	aa1 = ( a1 + a2 + a3 +a4 + a5) / 5 ;
	bb1 = ( b1 + b2 + b3 +b4 + b5) / 5 ;
	cc1 = ( c1 + c2 + c3 +c4 + c5) / 5 ;
// stats average sum	
	aa2 = ((long double)pow(a1,2) + (long double)pow(a2,2) + (long double)pow(a3,2) + (long double)pow(a4,2) + (long double)pow(a5,2) ) / 5	;
	bb2 = ((long double)pow(b1,2) + (long double)pow(b2,2) + (long double)pow(b3,2) + (long double)pow(b4,2) + (long double)pow(b5,2) ) / 5 ;
	cc2 = ((long double)pow(c1,2) + (long double)pow(c2,2) + (long double)pow(c3,2) + (long double)pow(c4,2) + (long double)pow(c5,2) ) / 5	;
